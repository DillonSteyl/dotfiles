...
vim.keymap.set('n', '<leader>dd', vim.diagnostic.open_float, { desc = '[D]iagnostic [D]isplay' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- Custom file finder that includes hidden files, but hides the .git directory
      ...
      vim.keymap.set('n', '<leader>sf', find_files_custom, { desc = '[S]earch [F]iles' })
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    dependencies = {
      ...
      -- Allows extra capabilities provided by nvim-lsp-file-actions
